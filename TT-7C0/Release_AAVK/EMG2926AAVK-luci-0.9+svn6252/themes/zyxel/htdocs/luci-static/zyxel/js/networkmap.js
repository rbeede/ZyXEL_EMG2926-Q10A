$(document).ready(
	...
	$(".powersafe").click(function() {
		...
		$(".unit_bandwidth_icon").css('background-image','url(/luci-static/zyxel/easy/images/i_powersaving.gif)');
	...
	$(".bandwidth").click(function() {
		...
		$(".unit_bandwidth_icon").css('background-image','url(/luci-static/zyxel/easy/images/i_bandwidth_c.gif)');
		var bH=$(window).height();
		var bW=$(window).width();
		$("#b-mask").css({width:bW,height:bH,display:"block"});
		$(".layer1").css({display:"block"});
	...
	$(".firewall").click(function() {
		...
		$(".unit_bandwidth_icon").css('background-image','url(/luci-static/zyxel/easy/images/i_firewall2.gif)');
		var bH=$(window).height();
		var bW=$(window).width();
	...
	$(".parental").click(function() {
		//$("#b-title").html("<b>Content Filter</b>");
		$(".unit_bandwidth_icon").css('background-image','url(/luci-static/zyxel/easy/images/i_parent.gif)');
		var bH=$(window).height();
		var bW=$(window).width();
	...
	$(".game").click(function() {
		...
		$(".unit_bandwidth_icon").css('background-image','url(/luci-static/zyxel/easy/images/i_game2.gif)');
		var bH=$(window).height();
		var bW=$(window).width();
	...
	// Internet Engine click
	$(".internet").click(function() {
		//$("#b-title").html("<b>Internet Engine</b>");
		$(".unit_bandwidth_icon").css('background-image','url(/luci-static/zyxel/easy/images/i_internet_c.gif)');
		var bH=$(window).height();
		var bW=$(window).width();
	...
	$(".wireless").click(function() {
		...
		$(".unit_bandwidth_icon").css('background-image','url(/luci-static/zyxel/easy/images/i_wireless_security2.gif)');
		var bH=$(window).height();
		var bW=$(window).width();
