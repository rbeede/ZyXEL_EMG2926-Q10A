...
*/
    ...
    */
    ...
    this.resizeNode = function()
    {
        ...
        $("#spacer").css({'width':nSpaceWidth+"px", 'height': 50 + 'px', 'display':'inline-table'});
    ...
    */
    ...
    /**
     * flowsFromMyMac - Return a copy of flows that matchs this mac address.
     *
     * @param  {object} flows flows from api.
     * @return {object}       Copy of flows, filtered.
     */
    this.flowsFromMyMac = function(flows) {

      //////////////////////////////////////////////////
      // error handling
      if (typeof flows == "undefined" || flows == null ||
          typeof self.strNodeID == "undefined" || self.strNodeID == null) {
        return null;
      }
      ...
      for (var index in flows) {
        //////////////////////////////////////////////////
        // error handling
        if (typeof flows[index].mac == "undefined" || flows[index].mac == null) {
          continue;
        }

        //////////////////////////////////////////////////
        // Add flow when mac adress matches.
        if (flows[index].mac == self.strNodeID) {
          result.push(flows[index]);
        }
            ...
            for(var nNode in myNodes)
            {
                ...
                else
                {
                    ...
                    for(var x in self.prevFlows)
                    {
                        ...
                        //////////////////////////////////////////////////
                        // error handling
                        if (typeof self.prevFlows[x].mac == "undefined" || self.prevFlows[x].mac == null) {
                          continue;
                        }

                        //////////////////////////////////////////////////
                        // skip when mac adress not match.
                        if (self.prevFlows[x].mac != self.strNodeID) {
                          continue;
                        }
    ...
    */
    ...
    this.updateNode = function()
    {
        ...
        self.updateGraphs(self.flowsFromMyMac(self.flows));
    ...
    */
    ...
    loadTranslationCloudWithCallback(function() {
        flowTable(function(){
            self.setup();
        });
    }); // loadTranslationCloudWithCallback
