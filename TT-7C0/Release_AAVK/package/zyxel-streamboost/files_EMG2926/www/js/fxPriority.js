...
*/
        ...
        if(bShowButtons != undefined && bShowButtons == true)
        {
            ...
            '<div class="priorityHeaderLine" style="margin-left:15px; font-size: 18px;" >Priorities</div>' +
			'<pre>' +
            _t(" ") +
			'</pre>' +
            '<div class="priorityBox">' +
            '    <div class="priorityText">' +
            _t("Prioritization allows you to assign or to modify priority to all the devices on your network. This function is useful when your devices share limited bandwidth with applications that have the same class of service.") +
            '</div>' +
			'<pre>' +
            _t(" ") +
			'</pre>' +
