...
#define CONFIG_DUAL_IMAGE_ROOTFS1_MTD_DEV	"/dev/mtdblock7"
#define CONFIG_DUAL_IMAGE_ROOTFS2_MTD_DEV	"/dev/mtdblock9"
/*-----------------------------------------------------------------------
...
#define PEGATRON_FACTORY_ENABLE             1
 ...
 * Board Configuration
 */
#define CONFIG_BOARD_EMG3425AAYJ	1
#define CONFIG_BOARD_NAME		"EMG-3425AAYJQ10A"
...
#error "Error!! This configuration is used for NOR+NAND feature on EMG3425AAYJ"
#endif
...
/* NOR flash */
  ...
  #define CFG_BOOT_FLAG_PART_ADDR	0x9f060000
  #define CFG_BOOT_FLAG_PART_SIZE	0x10000
 #endif
/* NAND Flash */
  ...
  #define CFG_BU1_PART_SIZE		0x200000
      ...
      #define CFG_BU2_PART_ADDR             0x4400000
      #define CFG_BU2_PART_SIZE             0x3A00000 //58M
     #endif /* PEGATRON_FACTORY_ENABLE */
 #else
...
#if CONFIG_DUAL_IMAGE
  #define BOOTARG_DEFAULT	"board=" CONFIG_BOARD_NAME " root=${bootmtd} rootfstype=jffs2 noinitrd ${bootmode} ${zld_ver}"
#else
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
    ...
    BOOT_FLASH_CMD \
    PEGATRON_FACTORY_ENV_STR \
    "bootcmd=run boot_flash\0" \
    IMG_ENV_VAL \
    UPGRADE_IMG_CMD \
    "countrycode=ff\0" \
    "serialnum=S100Z47000001\0" \
    "hostname=EMG-3425AAYJQ10A\0"
...
/* don't enable option 'CONFIG_CMD_MTDPARTS' */
