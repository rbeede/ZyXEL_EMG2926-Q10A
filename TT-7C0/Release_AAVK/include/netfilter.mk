...
ifdef CONFIG_PACKAGE_zyxel_qos_sp
$(eval $(call nf_add,IPT_IPOPT,CONFIG_IP_NF_MATCH_ETHER, $(P_V4)ipt_ether))
$(eval $(call nf_add,IPT_IPOPT,CONFIG_NETFILTER_XT_MATCH_ETHER, $(P_XT)xt_ether))
endif
...
ifdef CONFIG_PACKAGE_zyxel_qos_sp
$(eval $(call nf_add,EBTABLES_IP4,CONFIG_BRIDGE_EBT_FTOS_T, $(P_EBT)ebt_ftos))
endif
